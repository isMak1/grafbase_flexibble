    ...
    <footer className="flexStart footer">
      <div className="flex flex-col gap-12 w-full">
        <div className="flex items-start flex-col">
          ...
          <p className="text-start text-sm font-normal mt-5 max-w-xs text-gray-100">Flexible is the world's leading community for creative to share, grow, and get hired.</p>
        </div>
